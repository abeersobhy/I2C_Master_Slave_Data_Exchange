...
#define I2C1  			((I2Cx_typedef*)I2C1_BASE)
#define I2C2  			((I2Cx_typedef*)I2C2_BASE)
...
#define I2C2_IRQ_EV			33
#define I2C2_IRQ_ER			34
...
#define NVIC_I2C1_EV_Enable			(NVIC_ISER0 |= (1 << 31)) //31
...
#define NVIC_I2C1_EV_Disable		(NVIC_ICER0 |= (1 << 31))  //31
